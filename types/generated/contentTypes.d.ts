...
export interface ApiContestRulesPageContestRulesPage
  extends Struct.SingleTypeSchema {
  collectionName: 'contest_rules_pages';
  info: {
    displayName: 'Contest Rules Page';
    pluralName: 'contest-rules-pages';
    singularName: 'contest-rules-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::contest-rules-page.contest-rules-page'
    >;
...
export interface ApiShowcaseItemShowcaseItem
  ...
  info: {
    ...
    pluralName: 'showcase-items';
    singularName: 'showcase-item';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSponsorSponsor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    catButtons: Schema.Attribute.Component<'shared.link-button', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiStoreStore extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    menuLink: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::contest-rules-page.contest-rules-page': ApiContestRulesPageContestRulesPage;
